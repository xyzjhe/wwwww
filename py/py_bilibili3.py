...
class Spider(Spider):  # 元类 默认的元类 type
    ...
    def getCookie(self):
        ...
        cookies_str = "buvid3=AC480466-F467-A4EC-B6C9-F3AA95709A0317408infoc; b_nut=1666763017; i-wanna-go-back=-1; _uuid=78D59351-FCD6-9286-E6E6-3A61F7B51E51020243infoc; buvid4=48ED2AFE-1086-B1D6-1E70-EE63A3A290B018702-022102613-JdiOxEHSqmFWaoE98FdXXw%3D%3D; fingerprint=088fdf119bc504d76c60466c6f497010; buvid_fp_plain=undefined; SESSDATA=7448d852%2C1682315043%2C04b49%2Aa2; bili_jct=c802fd10f3b6c958e0666b2d53fbe463; DedeUserID=29803158; DedeUserID__ckMd5=1a97fc9755184b19; CURRENT_FNVAL=16; b_ut=5; buvid_fp=088fdf119bc504d76c60466c6f497010; PVID=1; innersign=0; b_lsid=102104B325_1847A111E15; bsource=search_bing"
        if cookies_str:
    ...
    config = {
        ...
        "舞蹈": [{
                ...
                {"key": "cid", "name": "分类",
                    "value":[{'n': '斗鱼', 'v': '斗鱼舞蹈'},{'n': '虎牙', 'v': '虎牙舞蹈'}, {'n': '王雨檬', 'v': '王雨檬'}, {'n': '萌七', 'v': '萌七'}, {'n': '米娜', 'v': '米娜呀'}, {'n': '南妹儿', 'v': '南妹儿'},{'n': '周淑怡', 'v': '周淑怡'}, {'n': '沫子', 'v': '沫子'}]
                },
                {
                    "key": "duration",
                    "name": "时长",
